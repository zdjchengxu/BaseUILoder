...
//        initMeasureParams();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int selfWidth = MeasureSpec.getSize(widthMeasureSpec) - paddingLeft - paddingRight;  //ViewGroup解析的宽度
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //如果需要换行
            if (childMesauredWidth + lineWidthUsed  > selfWidth - paddingLeft - paddingRight) {
                ...
                lineHeights.add(parentNeededHeight);
        ...
        int realWidth = (widthMode == MeasureSpec.EXACTLY) ? selfWidth: parentNeededWidth + getPaddingLeft() + getPaddingRight();
        int realHeight = (heightMode == MeasureSpec.EXACTLY) ?selfHeight: parentNeededHeight + getPaddingTop() + getPaddingBottom();
...
//                int right = left + view.getWidth();
                ...
                view.layout(left ,top + getPaddingTop(), right + getPaddingRight(),bottom + getPaddingBottom());
                curL = right + mHorizontalSpacing;
            }
            curL = 0 + getPaddingLeft();
            curT =  lineHeight;
        }
    }
