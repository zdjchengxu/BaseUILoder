...
public class DownTimeView extends View {
    private static final int DEFAULT_MIN_WIDTH = 400; //View默认最小宽度
    private static final int RED = 105, GREEN = 205, BLUE = 0; //基础颜色，这里是橙红色
...
//                Timber.e("timer running");
    ...
    public DownTimeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DownTimeView(Context context, AttributeSet attrs, int defStyleAttr) {
